...
//   return (
//     <div className=" w-full h-screen pl-6">
...
//       {/* <Spline scene="https://prod.spline.design/Ut6-u4zKMonMrzN2/scene.splinecode" /> */}
//     </div>
//   );
// }
"use client";
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              ...
              Originating from Pasuruan, East Java, Indonesia, I&rsquo;m
              currently embarking on a fascinating journey at{" "}
              <span className="text-black font-medium">
              ...
              believe that in today&rsquo;s fast-paced digital landscape, being
              a<span className="text-black font-medium"> lifelong learner</span>{" "}
              is not just a choice, but a necessity. Let&rsquo;s connect and
